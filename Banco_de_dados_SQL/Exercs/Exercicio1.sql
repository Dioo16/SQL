...
--filmes 21
--roupas 53, descobrindo que a quantidade de pessoas trabalhando em roupas é maior, logo, começando a ordernar por ele,
-- pois assim, garante uma perfomace melhor.
SELECT IdFuncionario, nome, email, sexo, departamento, admissao, salario, cargo, idRegiao from funcionarios
...
SELECT IdFuncionario, nome, email, sexo, departamento, admissao, salario, cargo, idRegiao from funcionarios
WHERE 
( departamento = 'lar' and SEXO = 'Feminino' ) --Usamos o parenteses pra indicar uma ordem, nesse caso:
-- tem que ser do sexo feminino e trabalhar nesses dois departamentos
or
...
-- 484 são masculinos, 47 trabalham no jardim, logo, começa-se a ordenação pelo masculino.
-- Finalizando, como estamos trabalhando com ''or'', colocamos a primeira condição qual tem mais chances de ser
-- a verdadeira, assim, a segunda condição não será checada na análise.
